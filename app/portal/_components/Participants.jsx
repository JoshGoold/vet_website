// app/portal/_components/Participants.jsx
"use client";
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 p-4 sm:p-6">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="mt-2 text-sm sm:text-base text-gray-400">
          Current Researchers: <span className="text-blue-400 font-semibold">{selections.length}</span>
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        {selections.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-lg text-gray-400 mb-4">No active participants yet.</p>
          </div>
        )}
      </div>
      ...
      {selections.length > 0 && (
        <div className="mt-6 text-center text-xs text-gray-500">
          ...
          <p>{selections.length} researchers currently active</p>
        </div>
      )}
    </div>
  );
